...
# Singleton instance
_query_rewrite_agent = None

def get_query_rewriter():
    """Get or create QueryRewriteAgent singleton"""
    global _query_rewrite_agent
    if _query_rewrite_agent is None:
        _query_rewrite_agent = QueryRewriteAgent()
    return _query_rewrite_agent
